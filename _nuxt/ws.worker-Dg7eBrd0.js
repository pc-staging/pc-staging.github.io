	...
	c(new class {
		...
		recordSubscription(e) {
			if (e !== this.pingMsg) try {
				const { method: t, params: n, subscription: s } = JSON.parse(e), i = void 0 !== s ? JSON.stringify(s) : Array.isArray(n) ? n[0] : n ?? "default";
				"subscribe" === t ? this.reconnectMessage[i] = e : "unsubscribe" === t && (delete this.reconnectMessage[i], "hl" === this.parseMode && s?.coin && O(s.coin));
			} catch {}
		}
		switchUrl(e) {
