(function() {
	...
	*/
	...
	function w(e) {
		...
		if (a.id = `${n}-${r}`, a.pair_id = `${t?.pair || ""}-${r}`, a.token = n, a.progress = 0, a.symbol = t?.symbol ?? (n === o ? t?.token0_symbol : t?.token1_symbol), a.name = t?.name ?? (n === o ? t?.token0_name : t?.token1_name), !a.logo_url) {
